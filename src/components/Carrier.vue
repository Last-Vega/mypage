  ...
  <section id="carrier" class="section no-h-padding">
    ...
    <div class="cardContainer">
      ...
      <ol class="content">
        ...
        <li>
          合同会社DMM.com: 2022.9 2 weeks 機械学習エンジニア
        </li>
        <li>
          株式会社リクルート: 2022.10~11 長期インターン データスペシャリスト
        </li>
        <li>
          株式会社サイバーエージェント: 2023.8~9 内定者アルバイト(メディア統括本部データサイエンスセンター)
        </li>
        <li>
    ...
    <div class="cardContainer">
      ...
      <ol class="content">
        ...
        <li>
          データベース技術: 2022.10~12 筑波大学 情報学群 知識情報・図書館学類
        </li>
        <li>
          データ構造とアルゴリズム: 2022.10~12 筑波大学 情報学群 知識情報・図書館学類
        </li>
        <li>
          プログラミング入門B: 2023.1~2 筑波大学 情報学群 知識情報・図書館学類
        </li>
        <li>
          データ工学概論: 2023.4~6 筑波大学 情報学群 情報メディア創成学類
        </li>
        <li>
          データ構造とアルゴリズム: 2023.10~12 筑波大学 情報学群 知識情報・図書館学類
        </li>
      </ol>
    </div>
    <hr />
